...
public:
    ...
    void Reset(){
        this->heaterConfigs[0]=HeaterConfig(NtcConfig(PIN_HEATER1_TEMP,NTC1_A,NTC1_B,NTC1_C),PidConfig(242.21f,1868.81f,128.49f,1000),1,PIN_HEATER1_HEATER);
        this->heaterConfigs[1]=HeaterConfig(NtcConfig(PIN_HEATER2_TEMP,NTC2_A,NTC2_B,NTC2_C),PidConfig(765.77f,1345.82f,604.67f,1000),2,PIN_HEATER2_HEATER);
        this->heaterConfigs[2]=HeaterConfig(NtcConfig(PIN_HEATER3_TEMP,NTC3_A,NTC3_B,NTC3_C),PidConfig(179.95f,2216.84f,81.62f,1000),3,PIN_HEATER3_HEATER);
